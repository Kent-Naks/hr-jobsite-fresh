        ...
        <>
          ...
          >
            ...
            <label className="block">
              <span className="text-sm font-medium">Upload CV (PDF/DOC)</span>
              <input
                type="file"
                accept=".pdf,.doc,.docx"
                required
              ...
              <div className="bg-white max-w-lg w-full rounded p-6 shadow-lg">
                ...
                <div className="text-sm text-gray-700 mb-4 max-h-80 overflow-y-auto space-y-2">
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>You may request the deletion of your information at any time by contacting the site administrators, but we cannot guarantee the removal of data already shared with third parties prior to your request.</li>
                  </ul>
