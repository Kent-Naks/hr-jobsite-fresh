...
// Arc positions for 5 items in a semicircle above the trigger (radius ~72px)
// Origin = center of trigger button; positive Y = up, positive X = right
        ...
        return (
          <button
            ...
            style={{
              ...
              // Fan out when open, collapse when closed
              ...(open
                ? {
